...
const Index = () => {
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-blue-500/30">
      <div className="fixed top-0 left-0 right-0 h-20 bg-background/50 backdrop-blur-md z-40 border-b border-white/5">
        <div className="max-w-6xl mx-auto px-4 h-full flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6 text-sm font-medium text-muted-foreground">
            <a href="#" className="hover:text-foreground transition-colors">Asosiy</a>
            <a href="#xizmatlar" className="hover:text-foreground transition-colors">Xizmatlar</a>
            <a href="#smm" className="hover:text-foreground transition-colors">SMM</a>
      ...
      <Chatbot />
      <footer className="py-8 text-center border-t border-white/5 text-muted-foreground mt-20">
