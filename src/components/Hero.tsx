      ...
      >
        <div className="mb-6 relative inline-block">
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-white/10 mx-auto">
            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop" alt="Abduxalidov Abdulloh" className="w-full h-full object-cover" />
          </div>
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed glass-card p-6 rounded-2xl">
        ...
        <motion.div className="mt-10 flex gap-4 justify-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }}>
          <a href="#aloqa" className="bg-foreground text-background px-8 py-3 rounded-full font-semibold hover:opacity-90 transition-opacity">Bog'lanish</a>
          <a href="#xizmatlar" className="glass-card px-8 py-3 rounded-full font-semibold hover:bg-white/10 transition-colors">Xizmatlar</a>
        </motion.div>
      </motion.div>
    </section>
  );
